...
author: Anne
lang: nl
translation: /en/2026/02/20/skills/
tags:
  - '2026'
  - 'ai'
  - 'maken'
...
> **Update 23 februari (1):** de [marktplaats](https://github.com/MinBZK/overheid-claude-plugins) is gegroeid naar 6 plugins met 49 skills. Nieuw: **internet-nl** (5 skills voor internetstandaarden-testen) en **geonovum** (6 skills voor geo-standaarden).

> **Update 23 februari (2):** De marktplaats is even op pauze. Soms moet je eerst [praten](/2025/03/13/verdwijnende-makers-tijd.html) voordat je verder kunt [maken](/2025/04/11/maken-over-schrijven.html). Wordt vervolgd.

> **Update 12 maart (3):** De marktplaats is weer live! Nu onder [developer-overheid-nl](https://github.com/developer-overheid-nl/skills-marketplace).

> **Update 25 maart (4):** Blogpost op [developer.overheid.nl](https://developer.overheid.nl/blog/2026/03/25/skills) over skills.

Maar Claude past niet uit zichzelf Nederlandse overheidsstandaarden toe. En daar hebben we er nogal wat van. [Honderden](https://www.forumstandaardisatie.nl/open-standaarden). [API Design Rules](https://gitdocumentatie.logius.nl/publicatie/api/adr/), [Digikoppeling](https://www.logius.nl/diensten/digikoppeling), [OAuth NL](https://logius-standaarden.github.io/OAuth-NL-profiel/), [CloudEvents](https://logius-standaarden.github.io/NL-GOV-profile-for-CloudEvents/), [geo-standaarden](https://www.geonovum.nl/geo-standaarden), WCAG, en zo verder. Ze staan beschreven in documenten die weinig developers lezen.
...
Twee commando's. Daarna kent Claude Code 77 Logius-standaarden. Omdat ik Markdown-bestanden heb laten genereren door Claude, op basis van de standaarden, met de juiste kennis erin.
